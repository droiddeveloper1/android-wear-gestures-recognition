...
public class PCA {
     ...
     * @param dimensionality Number of elements in each sample.
     */
    ...
    /**
     * Compute partial euclidean distance instead of full square root.
     * Computation speed is essential for real-time performance; this technique is faster than applying square root function.
     *
     * @param a
     * @param b
     * @return
     */
    public static double partialEuclidean(Coord2D a, Coord2D b)
    {
        double dist = 0.0d;

        double vector1 = a.getA()-b.getA(),
               vector2 = a.getB()-b.getB();

        dist = vector1*vector1 + vector2*vector2;

        return(dist);
    }

    /**
     * Computes euclidean distance between 2 2D points
     *
     * @param a
     * @param b
     * @return
     */
    public static double euclidean(Coord2D a, Coord2D b)
    {
        double dist = 0.0d;
        ...
        dist = Math.sqrt(vector1 * vector1 + vector2 * vector2);
